pipeline {
    ...
    environment {
        ...
        DOCKERHUB_USERNAME = 'akankshatech'  // Set this directly to your Docker Hub username
    ...
    stages {
        stage('Git Checkout') {
            steps {
                git branch: 'main', url: 'https://github.com/akanksha106-code/SonarQube-Project.git'
            }
        }
